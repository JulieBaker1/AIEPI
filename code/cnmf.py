...
class cNMF():
    ...
    def k_selection_plotV2(self, close_fig=True):
        '''
        Borrowed from Alexandrov Et Al. 2013 Deciphering Mutational Signatures
        publication in Cell Reports
        '''
...
if __name__=="__main__":
    ...
    parser.add_argument('command', type=str, choices=['prepare', 'factorize', 'combine', 'consensus', 'k_selection_plot','k_selection_plotV2'])
    ...
    elif args.command == 'k_selection_plotV2':
        cnmf_obj.k_selection_plotV2()